...
[![Run on Brainlife.io](https://img.shields.io/badge/Brainlife-brainlife.app.197-blue.svg)](https://doi.org/10.25663/brainlife.app.197)

# Remove First B0 (temp)

This app will remove the first b0 from a diffusion MRI image.
...
You can submit this App online at [https://doi.org/10.25663/brainlife.app.197](https://doi.org/10.25663/brainlife.app.197) via the 'Execute' tab.
...
```json
{
    "dwi": "/input/inDWI/dwi.nii.gz",
    "bvecs": "/input/inDWI/bvecs.nii.gz",
    "bvals": "/input/inDWI/bvals.nii.gz"
}
```
